...
('3f64293e-93eb-4bc0-8839-5dadbfb12a5a', 'Bidder', 'bidder', '{\"summary\":\"Participates in auctions by submitting bids and related payments.\",\"permissions\":{\"modules\":[\"bids\",\"payments\",\"cpo\",\"notifications\"],\"actions\":[\"create\",\"read\",\"update\"],\"routes\":[\"POST /api/v1/bids\",\"GET /api/v1/bids/my\",\"POST /api/v1/payments\",\"GET /api/v1/payments\",\"POST /api/v1/cpo\",\"GET /api/v1/notifications\"]},\"permissionVersion\":1}', 1, '2026-06-17 14:27:23', '2026-06-17 07:27:24'),
