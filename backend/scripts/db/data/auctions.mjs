...
export const SEED_LOT_IDS = Object.freeze(
  SEED_AUCTIONS.flatMap((auction) => auction.lots.map((lot) => lot.id)),
);

export const SEED_ASSET_IDS = Object.freeze(
  SEED_AUCTIONS.flatMap((auction) => auction.lots.map((lot) => lot.assetId)),
);

export const SEED_EVALUATION_IDS = Object.freeze(
  SEED_AUCTIONS.flatMap((auction) => auction.lots.map((lot) => lot.evaluationId)),
);
